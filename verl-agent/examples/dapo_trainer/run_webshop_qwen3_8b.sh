...
# ---------------------------------------------------------------------------
# Qwen3-8B DAPO (GRPO + dynamic sampling + clip-higher) full training on WebShop.
...
# dedicated conda env. Adjust the conda activation below to your WebShop env.
# ---------------------------------------------------------------------------

export HF_HOME=/volume/posttrain/users/zhouyz/hf
# export CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0,1,2,3}
export VLLM_ATTENTION_BACKEND=FLASH_ATTN
export TENSORBOARD_DIR=${TENSORBOARD_DIR:-/volume/posttrain/users/zhouyz/verl_agent_tb/dapo_qwen3_8b_webshop}
