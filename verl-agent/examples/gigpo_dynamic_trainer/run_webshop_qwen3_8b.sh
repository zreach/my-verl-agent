...
# ---------------------------------------------------------------------------
# Qwen3-8B GiGPO (dynamic: + dynamic sampling + clip-higher) full training on WebShop.
...
export TENSORBOARD_DIR=${TENSORBOARD_DIR:-/volume/posttrain/users/zhouyz/verl_agent_tb/gigpo_dynamic_qwen3_8b_webshop}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='gigpo_dynamic_qwen3_8b' \
