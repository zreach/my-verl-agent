...
# ---------------------------------------------------------------------------
# Qwen3-8B GiGPO full training on WebShop.
...
export TENSORBOARD_DIR=${TENSORBOARD_DIR:-/volume/posttrain/users/zhouyz/verl_agent_tb/gigpo_qwen3_8b_webshop}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='gigpo_qwen3_8b' \
